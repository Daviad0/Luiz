#pragma checksum "/Users/daviado/Downloads/Luiz/LuizApp/LuizApp/Views/Home/Master.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c09b0f9bd339949396134b6c80c8a7b2f0d709dd"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c09b0f9bd339949396134b6c80c8a7b2f0d709dd", @"/Views/Home/Master.cshtml")]
...
#line hidden
    ...
    .rank23leaderboard {
        ...
        background: linear-gradient(145deg, rgba(0,191,255,1) 0%, ");
            WriteLiteral(@"rgba(0,255,169,1) 100%);
    }
    .rank4567leaderboard {
        background: rgb(0,255,169);
        background: linear-gradient(145deg, rgba(0,255,169,1) 0%, rgba(13,7,116,1) 100%);
    }
</style>
...
<div style=""margin-top:20px"">
    <div id=""questionp"">
        ...
        <table style=""position: absolute; top: 8vh; bottom: 0; left: 0; right: 0;width:100%"">
            <tr>
                ...
                <td style=""width:9");
            WriteLiteral(@"0%;text-wrap:inherit;padding:30px;background-color:lightgray;border:4px solid lightgray;border-radius:0px 6px 6px 0px"">
        ...
        <table style=""width:100%;border-spacing:0 15px;border-collapse:separate;margin-top:15vh"">
            ...
            <tr>
                ...
                <td style=""width:90%;text-wrap:inherit;padding:30px;background-color:#42c5f5;border:4px solid #42c5f5;border-radius:0px 6px 6px 0px"">
                    <span style=""font-size:30px;vertical-align:text-bottom;font-family:Georgia, 'Times New Roman', Times, serif""");
            WriteLiteral(@">1</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style=""width:90%;text");
            WriteLiteral(@"-wrap:inherit;padding:30px;background-color:#3ce663;border:4px solid #3ce663;border-radius:0px 6px 6px 0px"">
    ...
    <div id=""resultsp"" style=""display:none"">
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                ...
                <td id=""num1c"" style=""width:90%;background-color:#42c5f5;co");
            WriteLiteral(@"lor:white;border-radius:8px"">
        ...
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
          ...
          ");
            WriteLiteral(@"      <td id=""num2w"" style=""width:0%;background-color:white;color:white"">
    ...
    <div id=""leaderboardp""  style=""display:none;text-align:center"">
        ...
        <br />
        <div class=""rank23leaderboa");
            WriteLiteral(@"rd"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
        ...
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            <span style=""font-size:25px;color:whi");
            WriteLiteral(@"te;font-weight:600"">2</span>
        ...
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            ...
            <span style=""font-size:25px;color:white;font-weight:600"">Daviado</span>
            <span sty");
            WriteLiteral(@"le=""font-size:25px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"">1999</span>
        </div>
        <br />
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            <span style=""font-size:25px;color:white;font-weight:600"">2</span>
...
");
            EndContext();
            BeginContext(12981, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "300607ebdf064fd39519a023fe6b4c25", async() => {
            }
            );
            ...
            EndContext();
            BeginContext(13042, 2, true);
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(13044, 51, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "20b1e7d9daff4fbe93fbe2fe0d1d35c2", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
