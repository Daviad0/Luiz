#pragma checksum "/Users/daviado/Downloads/Luiz/LuizApp/LuizApp/Views/Home/Master.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "79702c4dabde3d4821a3009dafd7d6462cc34e96"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"79702c4dabde3d4821a3009dafd7d6462cc34e96", @"/Views/Home/Master.cshtml")]
...
<div style=""margin-top:20px"">
    <div id=""loginscreen"" style=""text-align:center"">
        <div style=""background-color:#03b1fc;font-size:60px;font-weight:600;padding:10px;border-radius:10px"">
            Game Key: <span id=""gamecode"" style=""color:white"">[UNAVAIL]</span><span id=""gameerror""style=""margin-left:10px"">&#9888;</span>
        </div>
    </div>
    <div id=""questionp"" style=""display:none"">
        ...
        ");
            WriteLiteral(@"            <span style=""font-weight:900;font-size:50px;text-align:center;margin-left:40px;color:gray"">Q</span>
                </td>
        ...
        <table style=""width:100%;border-spacing:0 15px;border-collapse:separate;margin-top:15vh"">
            ...
            <tr>
                ...
                <td style=""width:90%;text-wrap:inherit;padding:30px;background-color:#42c5f5;border:4px solid");
            WriteLiteral(@" #42c5f5;border-radius:0px 6px 6px 0px"">
            ...
            <tr>
                <td style=""width:10%;overflow:hidden;background-color:white;border:4px solid #3ce663;border-radius:6px 0px 0px 6px"">
                  ");
            WriteLiteral(@"  <span style=""font-weight:900;font-size:50px;text-align:center;margin-left:40px;color:#3ce663"">3</span>
                </td>
            ...
            <tr>
                ...
                <td style=""width:90%;text-wrap:inherit;padding:30px;background-color:#e6c73c;border:4px solid #e6c73c;border-radius:0px 6px 6px 0px"">
                    <span style=""font-size:30px;vertical-align:text-bottom;font-family:Georgia, 'Times New Roman'");
            WriteLiteral(@", Times, serif"">The answer is triangle!</span>
                </td>
            </tr>
        </table>
        <table width=""100%"">
    ...
    <div id=""resultsp"" style=""display:none"">
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                <td style=""width:10%;color:#42c5f5"">
                    <span id=""nu");
            WriteLiteral(@"m1l"" style=""font-weight:900;font-size:50px;text-align:center"">1</span>
                </td>
        ...
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                ...
                <td id=""num2c"" style=""width:90%;background-color:#f54284;color:white;bor");
        ...
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                ...
                <td id=""num3w"" style=""wid");
            WriteLiteral(@"th:0%;background-color:white;color:white"">
                    <span style=""font-weight:900;font-size:40px;text-align:center;padding-top:0vh""></span>
                </td>
            </tr>
            </table>
       ...
       ");
            WriteLiteral(@" <span id=""num1"" style=""background-color:black;padding:5px;color:white"">0</span>
    ...
    <div id=""leaderboardp""  style=""display:none;text-align:center"">
        ...
        <div class=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
            ...
            <span ");
            WriteLiteral(@"style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"">2000</span>
        </div>
        <br />
        <div class=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
        ...
        <br />
    ");
            WriteLiteral(@"    <div class=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
        ...
        <div class=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
            <span st");
            WriteLiteral(@"yle=""font-size:30px;color:white;font-weight:600"">6</span>
            <span style=""font-size:30px;color:white;font-weight:600"">Daviado</span>
...
");
            EndContext();
            BeginContext(13144, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "31d9a820d306451f838a2f2c90d37e99", async() => {
            }
            );
            ...
            EndContext();
            BeginContext(13205, 2, true);
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(13207, 51, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0f810a714d104226b5698498437d14c3", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
