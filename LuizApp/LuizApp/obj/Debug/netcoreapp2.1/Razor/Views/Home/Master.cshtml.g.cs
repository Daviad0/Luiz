#pragma checksum "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "493f79910e17ee7b0ae901fd288993899e2fd526"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"493f79910e17ee7b0ae901fd288993899e2fd526", @"/Views/Home/Master.cshtml")]
...
#line hidden
    ...
    .rank1leaderboard {
        background: rgb(240,126,84);
        background: linear-gradient(135deg, rgba(240,126,84,1) 0%, rgba(240,217,84,1) 100%);
    }
    .rank23leaderboard {
        background: rgb(84,168,240);
        background: linear-gradient(135deg, rgba(84,168,24");
            WriteLiteral(@"0,1) 0%, rgba(84,240,170,1) 100%);
    }
    .rank4567leaderboard {
        background: rgb(106,106,106);
        background: linear-gradient(135deg, rgba(106,106,106,1) 0%, rgba(214,214,214,1) 100%);
    }
</style>
...
<div style=""margin-top:20px"">
    <div id=""questionp"">
        ...
        <table style=""position: absolute; top: 8vh; bottom: 0; left: 0; right: 0;width:100%"">
            <tr>
                ...
                <");
            WriteLiteral(@"td style=""width:90%;text-wrap:inherit;padding:30px;background-color:lightgray;border:4px solid lightgray;border-radius:0px 6px 6px 0px"">
        ...
        <table style=""width:100%;border-spacing:0 15px;border-collapse:separate;margin-top:15vh"">
            ...
            <tr>
                ...
                <td style=""width:90%;text-wrap:inherit;padding:30px;background-color:#42c5f5;border:4px solid #42c5f5;border-radius:0px 6px 6px 0px"">
                    <span style=""font-size:30px;vertical-align:text-bottom;font-family:Georgia, 'Times New Roma");
            WriteLiteral(@"n', Times, serif"">1</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td styl");
            WriteLiteral(@"e=""width:90%;text-wrap:inherit;padding:30px;background-color:#3ce663;border:4px solid #3ce663;border-radius:0px 6px 6px 0px"">
    ...
    <div id=""resultsp"" style=""display:none"">
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                ...
                <td id=""num1c"" style=""width:90%;background");
            WriteLiteral(@"-color:#42c5f5;color:white;border-radius:8px"">
        ...
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                <td style=""width:10%;color:#3ce663"">
                    <span id=""num3l"" style=""font-weight:900;font-size:50px;text-align:center"">3</span>
                </td>
 ...
 ");
        ...
        <table style=""width:100%;text-align:center;border-spacing:0 15px;border-collapse:separate"">
            <tr>
                ...
                <td id=""num4c"" style=""width:90%;background-color:#e6c73c;color:white;border-radius:8px"">
                    <span id=""num4"" style=""font-weight:700;font-size:40px;text-align:center;padding-top:0vh"">0</span>
                </td>
        ...
        <span id=""num2"" style=""background-color:black;padding:5px;color");
            WriteLiteral(@":white"">0</span>
    ...
    <div id=""leaderboardp""  style=""display:none;text-align:center"">
        <br />
        <br />
        <div class=""rank1leaderboard"" style=""border-radius:10px;padding:20px;display:flex;justify-content:space-between"">
            <span style=""font-size:50px;color:white;font-weight:600"">1</span>
            <span style=""font-size:50px;color:white;font-weight:600"">Daviado</span>
            <span style=""font-size:50px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"">2000</span>
        </div>
        <br />
        <div class");
            WriteLiteral(@"=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
        ...
        <br />
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            <span style=""font-si");
            WriteLiteral(@"ze:25px;color:white;font-weight:600"">2</span>
            <span style=""font-size:25px;color:white;font-weight:600"">Daviado</span>
            <span style=""font-size:25px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"">1999</span>
        </div>
        <br />
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            <span style=""font-size:25px;color:white;font-weight:600"">2</span>
            <span style=""font-size:25px;color:white;font-weight:600"">Daviado</span>
            <span style=""font-size:25px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"">1999</span>
        </div>
        <br />
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            ...
            <span style=""font-size:25px;color:white;font-weight:600"">Daviado</span>
    ");
            WriteLiteral(@"        <span style=""font-size:25px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"">1999</span>
        </div>
        <br />
        <div class=""rank4567leaderboard"" style=""border-radius:10px;padding:12px;display:flex;justify-content:space-between"">
            <span style=""font-size:25px;color:white;font-weight:600"">2</span>
...
");
            EndContext();
            BeginContext(12998, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8ae33f4f8b1e4eab9a3bccaffe9da9b4", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "74f611e163794b018d4bce69c4c1d2f2", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
<script>
    ...
    quiz.on(""sendLeaderboard"", function (TopTen) {
      ");
            WriteLiteral(@"  $(""#userleaderboard"").empty();
    ...
    quiz.start().then(function () {
        ...
        function ShowLeaderboard() {
            ...
            $(""#resultsp"").css(""display"", ""none"");
            $(""#l");
            WriteLiteral("eaderboardp\").css(\"display\", \"inline\");\n            quiz.invoke(\"getLeaderboard\");\n        }\n    });\r\n    \r\n</script>");
            EndContext();
        }
