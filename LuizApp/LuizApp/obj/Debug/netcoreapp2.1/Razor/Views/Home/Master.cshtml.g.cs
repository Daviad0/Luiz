#pragma checksum "/Users/daviado/Downloads/Luiz/LuizApp/LuizApp/Views/Home/Master.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7d568e93848fe4ae6928bb2b4305fe8ac687667f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7d568e93848fe4ae6928bb2b4305fe8ac687667f", @"/Views/Home/Master.cshtml")]
...
#line default
#line hidden
#line 62 "/Users/daviado/Downloads/Luiz/LuizApp/LuizApp/Views/Home/Master.cshtml"
...
#line 80 "/Users/daviado/Downloads/Luiz/LuizApp/LuizApp/Views/Home/Master.cshtml"
         Write(questionlist);

#line default
#line hidden
            EndContext();
            BeginContext(2714, 9459, true);
            WriteLiteral(@"</span>
    ...
    <div id=""questionp"" style=""display:none"">
        ...
        <table style=""width:100%;border-spacing:0 15px;border-collapse:separate;margin-top:15vh"">");
            ...
            <tr>
                ...
                <td style=""width:90%;text-wrap:inherit;padding:30px;background-");
            WriteLiteral(@"color:#f54284;border:4px solid #f54284;border-radius:0px 6px 6px 0px"">
            ...
            <tr>
                <td style=""width:10%;overflow:hidden;background-color:white;border:4px solid #e6c73c;border-radius:6px 0px");
            WriteLiteral(@" 0px 6px"">
    ...
    <div id=""resultsp"" style=""display:none"">
        ...
        <table style=""width:100%;font-size:70px;text-align:center;font-weight:600"">
            <tr>
                <td style=""width:25%;margin-right:10px;background-color:#cccccc;color:white"" class=""num1c"">
                    #1 <span id=""num1"" style=""background-colo");
            WriteLiteral(@"r:white;color:#cccccc;padding-left:5px;padding-right:5px;border-radius:6px"">0</span>
                </td>
        ...
        <input type=""button"" id=""le");
            WriteLiteral(@"aderboard"" value=""Leaderboard"" />
    </div>
    <div id=""leaderboardp""  style=""display:none;text-align:center"">
        ...
        <div class=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
        ");
            WriteLiteral(@"    <span style=""font-size:30px;color:white;font-weight:600"">5</span>
            <span style=""font-size:30px;color:white;font-weight:600"">Daviado</span>
        ...
        <div class=""rank23leaderboard"" style=""border-radius:10px;padding:15px;display:flex;justify-content:space-between"">
            ...
            <span style=""font-size:30px;color:white;font-weight:600"">");
            WriteLiteral("Daviado</span>\r\n            <span style=\"font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle\">1994</span>\r\n        </div>\r\n        <input type=\"button\" id=\"next\" value=\"Next Question\" />\r\n    </div>\r\n    </div>\r\n");
            EndContext();
            BeginContext(12173, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4f4568125b174fa4b904840caffaeff5", async() => {
            }
            );
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(12236, 51, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8eab8dad5a4b41b590bcad8322f40439", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
<script>
    ...
    var Questions = [rfc3986EncodeURIComponent(""");
            EndContext();
            BeginContext(13828, 23, false);
#line 269 "/Users/daviado/Downloads/Luiz/LuizApp/LuizApp/Views/Home/Master.cshtml"
                                           Write(questionlist.ToString());

#line default
#line hidden
            EndContext();
            BeginContext(13851, 5465, true);
            WriteLiteral(@""")];
    ...
    for (i = 0; i < numQuestions; i++) {
        $(""#questionslist"").append(""<tr><td>"" + (i + 1) + ""</td><td>"" + Questions[i][6] + ""</td></tr>"")
    }
    quiz.on(""questionResults"", function (Correct, Wrong, Num1, Num2, Num3, Num4) {
        ...
        $(""");
            WriteLiteral(@"#num2c"").css(""width"", num2percent + ""%"")
    ...
    quiz.on(""sendLeaderboard"", function (TopTen) {
        ...
        $.each(TopTe");
            WriteLiteral(@"n, function (index, value) {
    ...
    quiz.start().then(function () {
       ...
       ");
            WriteLiteral(@" $(""#checkanswer3"").click(function () {
            ShowResults(3);
        });
        ...
        f");
            WriteLiteral(@"unction Countdown() {
            Timer = Timer - 1;
