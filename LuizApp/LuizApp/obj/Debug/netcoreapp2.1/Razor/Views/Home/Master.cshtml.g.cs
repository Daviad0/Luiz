#pragma checksum "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a242184b82b8cd960e384c66517bf41122c7ce23"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a242184b82b8cd960e384c66517bf41122c7ce23", @"/Views/Home/Master.cshtml")]
    ...
    public class Views_Home_Master : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<Question>>
    {
        ...
        {
#line 3 "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml"
  
    ViewData["Title"] = "Master";

#line default
#line hidden
            BeginContext(84, 1897, true);
            WriteLiteral(@"<style>
...
");
            EndContext();
#line 94 "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml"
  
    string questionlist = "";

#line default
#line hidden
#line 97 "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml"
...
#line default
#line hidden
#line 101 "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml"
...
<div style=""margin-top:20px"">
    ...
    <div id=""questionp"" style=""display:none"">
        <table style=""position: absolute; top: 0; bottom: 0; left: 0; right: 0;width:100%"">
            <tr>
                <td style");
            WriteLiteral(@"=""width:10%;overflow:hidden;background-color:white;border:4px solid lightgray;border-radius:6px 0px 0px 6px"">
        ...
        <table style=""width:100%;border-spacing:0 15px;border-collapse:separate;margin-top:15vh"">
         ...
         ");
            ...
            <tr>
         ");
            WriteLiteral(@"       <td style=""width:10%;overflow:hidden;background-color:white;border:4px solid #3ce663;border-radius:6px 0px 0px 6px"">
    ...
    <div id=""resultsp"" style=""display:none"">
        ...
        <table style=""width:100%;font-size:70px;text-align:center;font-weight:600"">
            <tr>
             ");
            WriteLiteral(@"   <td style=""width:25%;margin-right:10px;background-color:#cccccc;color:white"" class=""num1c"">
                ...
                <td style=""width:25%;margin-right:10px;background-color:#cccccc;color:white"" class=""num4c"">
                    #4 <span id=""num4"" style=""background-color:white;color:#cccccc;padding-left");
            WriteLiteral(@":5px;padding-right:5px;border-radius:6px"">0</span>
                </td>
            </tr>
        </table>
    ...
    <div id=""leaderboardp"" style=""display:none;text-align:center"">
        <table class=""rank23leaderboard"" id=""r1"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:20%;padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600"">#1</span>
                </td>
                <td style=""width:60%;padding-bottom:15px;padding-top:15px;text-align:center"">
                    <span style=""font-size:30px;color:white;font-weight:600"" id=""r1user"">Daviado</span>
                </td>
                <td style=""width:20%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:");
            WriteLiteral(@"4px;vertical-align:middle"" id=""r1pts"">2000</span>
                </td>
            </tr>
        </table>
        <br />
        <table class=""rank23leaderboard"" id=""r2"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600"">#2</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:center"">
                    <span style=""font-size:30px;color:white;font-weight:600"" id=""r2user"">Daviado</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"" id=""r2pts"">2000</span>
                </td>
            </tr>
        </table>
        <br />
        <table c");
            WriteLiteral(@"lass=""rank23leaderboard"" id=""r3"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600"">#3</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:center"">
                    <span style=""font-size:30px;color:white;font-weight:600"" id=""r3user"">Daviado</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"" id=""r3pts"">2000</span>
                </td>
            </tr>
        </table>
        <br />
        <table class=""rank23leaderboard"" id=""r4"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:25%;");
            WriteLiteral(@"padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600"">#4</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:center"">
                    <span style=""font-size:30px;color:white;font-weight:600"" id=""r4user"">Daviado</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"" id=""r4pts"">2000</span>
                </td>
            </tr>
        </table>
        <br />
        <table class=""rank23leaderboard"" id=""r5"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                    <span style=""font-size:30px;color:white;font-we");
            WriteLiteral(@"ight:600"">#5</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:center"">
                    <span style=""font-size:30px;color:white;font-weight:600"" id=""r5user"">Daviado</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"" id=""r5pts"">2000</span>
                </td>
            </tr>
        </table>
        <br />
        <table class=""rank23leaderboard"" id=""r6"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                ...
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:center"">
    ");
            WriteLiteral(@"                <span style=""font-size:30px;color:white;font-weight:600"" id=""r6user"">Daviado</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"" id=""r6pts"">2000</span>
                </td>
            </tr>
        </table>
        <br />
        <table class=""rank23leaderboard"" id=""r7"" style=""width:100%;border-radius:10px;padding:15px;"">
            <tr>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:left;padding-left:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600"">#7</span>
                </td>
                <td style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:center"">
                    <span style=""font-size:30px;color:white;font-weight:600"" id=""r7user"">Daviado</span>
                </td>
                <t");
            WriteLiteral(@"d style=""width:25%;padding-bottom:15px;padding-top:15px;text-align:right;padding-right:15px"">
                    <span style=""font-size:30px;color:white;font-weight:600;border-radius:4px;vertical-align:middle"" id=""r7pts"">2000</span>
                </td>
            </tr>
        </table>
...
<div style=""background-color:#03b1fc;border:none"" class=""footer"">
    <div class=""container"" style=""text-align:center;margin-top:10px"">
        ...
        <div style=""border:3px solid #03b1fc;border-radius:20px;margin-bottom:10px"">
            ...
            EndContext();
            BeginContext(15770, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6974f2c4298c4f5b920c3e801addf988", async() => {
            }
            );
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(15833, 51, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9beecce608124d8bad1c3a0d2c05df3a", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
<script>
    ...
    var QuestionsList = [");
            EndContext();
            BeginContext(17440, 12, false);
#line 355 "C:\Users\djree\source\repos\Luiz\LuizApp\LuizApp\Views\Home\Master.cshtml"
                    Write(questionlist);

#line default
#line hidden
            EndContext();
            BeginContext(17452, 7914, true);
            WriteLiteral(@"];
    var QuestionIndex = 0;
    ...
    quiz.start().then(function () {
        quiz.on(""questionLoaded"", function (QuestionLoaded) {
            $(""#questionte");
            WriteLiteral(@"st"").html(QuestionLoaded.correctAnswer);
            var i = 0
 ...
 ");
       ...
       ");
            WriteLiteral(@"     $(""#qsa4"").html(QuestionLoaded.question4);
        ...
        function ShowLeaderboard() {
            ...
            quiz");
            WriteLiteral(@".invoke(""getLeaderboard"");
